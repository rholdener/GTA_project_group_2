...
app = Flask(__name__)
CORS(app, origins=["*", "null", "https://air-pollution-gta.vercel.app"], resources={r"/*": {"origins": "https://air-pollution-gta.vercel.app"}})  # allowing any origin as well as localhost (null)
